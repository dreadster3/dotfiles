return {
    {
        ...
        opts = function()
            ...
            local sources = {
                ...
                formatting.clang_format, formatting.autopep8, formatting.taplo,
                formatting.isort, formatting.autoflake, formatting.gofmt,
                formatting.rustywind, formatting.nixfmt, formatting.beautysh,
                formatting.latexindent, diagnostics.eslint, diagnostics.tfsec,
