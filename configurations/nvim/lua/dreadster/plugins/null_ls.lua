		...
		opts = function()
			...
			return {
				sources = {
					...
					formatting.taplo, formatting.isort, formatting.autoflake,
					formatting.gofmt, formatting.rustywind, formatting.nixfmt,
					formatting.beautysh, formatting.latexindent,
					diagnostics.eslint, diagnostics.tfsec, diagnostics.mypy,
					diagnostics.flake8
				},
